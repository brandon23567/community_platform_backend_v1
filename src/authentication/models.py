...
class UserModel(Base):
    ...
    user_community_posts = relationship("CommunityPostModel", back_populates="user")
    user_posts_comments = relationship("CommunityPostCommentModel", back_populates="user")